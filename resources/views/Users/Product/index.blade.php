...
<div class="products-page-wrapper">
    <div class="container">
        ...
        <div class="filter-section">
            <form action="{{ route('products.index') }}" method="GET" class="filter-form">
                ...
                <div class="filter-group filter-buttons">
                    ...
                    <a href="{{ route('products.index') }}" class="btn-filter btn-clear-filter" title="إلغاء الفلترة">
        ...
        @if($products->count() > 0)
            <div class="products-grid">
                ...
                <div class="product-card">
                    ...
                    <div class="product-details">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('products.show', $product['id']) }}" class="btn-add-to-cart">إضافة للعربة</a>
           ...
           @elseif($alternatives->count() > 0)
    {{-- **الجديد:** إذا لم تكن هناك نتائج ولكن هناك بدائل مقترحة --}}
    <div class="text-center py-5">
        <i class="fas fa-lightbulb fa-4x text-warning mb-3"></i>
        <h4 class="text-muted">لم نجد ما تبحث عنه بالضبط بخصوص "{{ $searchTerm }}"</h4>
        <p class="text-muted">لكن قد تعجبك هذه المنتجات المقترحة من نفس الفئة:</p>
    </div>
    <div class="products-grid">
...
@else
    {{-- إذا لم يكن هناك أي شيء على الإطلاق --}}
    <div class="text-center py-5">
        <i class="fas fa-search-minus fa-4x text-muted mb-3"></i>
        <h4 class="text-muted">عفواً، لا توجد منتجات تطابق بحثك.</h4>
        <p class="text-muted">جرّب تغيير كلمات البحث أو إلغاء الفلاتر.</p>
        <a href="{{ route('products.index') }}" class="btn btn-primary mt-3">عرض كل المنتجات</a>
    </div>
