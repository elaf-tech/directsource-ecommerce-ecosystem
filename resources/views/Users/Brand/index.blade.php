            ...
            @forelse($brand as $brand)
                ...
                <a href="#" class="category-card-v2">
                    <div class="img-container">
                        @if($brand->image)
                            <img src="{{ asset('storage/' . $brand->image) }}" class="category-img" alt="{{ $brand->name }}">
                        @else
                            {{-- صورة افتراضية أفضل --}}
                            <img src="https://via.placeholder.com/300x180.png/f4f7f6/6c757d?text={{ urlencode($brand->name ) }}" class="category-img" alt="{{ $brand->name }}">
                        @endif
                    </div>
                    <div class="card-content">
                        ...
                        <p class="category-desc">
                            ...
                            {{ Str::limit($brand->description ?? 'وصف موجز لهذه الفئة المميزة.', 80) }}
                        </p>
