...
<style>
    /* === تصميم صفحة إضافة ماركة الجديدة === */
            ...
            <div class="form-card-body">
                ...
                <form action="{{ route('brands.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control-custom" id="name"  placeholder="" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control-custom" id="description" rows="4" placeholder="اكتب وصفًا موجزًا وجذابًا عن هذه الماركة..."></textarea>
                        @error('description')
                            <small class="text-danger mt-1 d-block">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <button type="submit" class="btn-submit-custom">
                        <i class="fas fa-check"></i> إضافة الماركة
                    </button>
                </form>
            </div>
        </div>
