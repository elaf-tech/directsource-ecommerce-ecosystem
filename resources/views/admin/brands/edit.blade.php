...
<div class="page-header">
    <h2 class="page-title"><i class="fas fa-edit"></i> تعديل الماركة</h2>
    <a href="{{ route('brandad.index') }}" class="btn-back"><i class="fas fa-arrow-right"></i> العودة لقائمة الماركات</a>
</div>

<div class="form-card">
    <form action="{{route('brandad.update',$brand->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <div class="form-header">
            <i class="fas fa-sitemap"></i>
            <h3>تعديل بيانات: {{ $brand->name }}</h3>
        </div>

        <div class="form-body">
            <!-- القسم الأول: بيانات الفئة -->
            <div class="form-section">
                <h4 class="form-section-title">بيانات الماركة</h4>
            ...
            <div class="form-section">
                <h4 class="form-section-title">صورة الماركة</h4>
                <div class="image-upload-section">
                    <img src="{{ $brand->image ? asset('storage/' . $brand->image) : 'https://via.placeholder.com/150x150.png/f0f5eb/4e6b3a?text=No+Image' }}" alt="الصورة الحالية" class="current-image-preview">
        ...
        <div class="form-footer">
            <a href="{{ route('brandad.index') }}" class="btn btn-cancel">إلغاء</a>
